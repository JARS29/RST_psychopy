...
expName = u'rst_2'  # from the Builder filename that created this script
...
for thisTrial in trials:
    ...
    print(sent_ok, index, order[index])
    key_resp_2 = event.BuilderKeyResponse()
    text.setText(Sentences + str(order[index]))
    # keep track of which components have finished
    trialComponents = [key_resp_2, text]
    ...
    # keep track of which components have finished
    recallComponents = [text_2, key_resp_3]
